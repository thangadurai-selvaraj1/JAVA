...
$result = mysqli_query($conn, "UPDATE uniqueid SET build='$build',locality='$locality' WHERE id=$id");
...
?>
 ...
 <form action="#" method="post">
            <input type="text" name="build" value="<?php echo$row["build"]  ;?>"placeholder="locality Name" required="">
            <input type="text" name="locality" value="<?php echo$row["locality"]  ;?>"placeholder="locality Name" required="">
