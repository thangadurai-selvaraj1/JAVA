...
<form action="#" method="post">
            <input type="text" name="phn"  placeholder="Enter the Phone No" required="">
...
$phn = $_POST["phn"];
$iiid=$_SESSION['user'];
$sqls="Select * FROM uniqueid Where phone='$phn'";
 ...
 echo "<tr>";
            ...
            echo "<td>".$row["city"]."</td>";
             echo "<td>".$row["state"]."</td>";
              echo "<td>".$row["pin"]."</td>";
              echo "<td><a class='up' href=\"editu.php?id=$row[id]\" >Edit</a> | <a class='up' href=\"deleteu.php?id=$row[id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";
  ...
  ?>
        ...
        alert("NO RECORD FOR THIS UNIQUE ID ");
        window.location="uidsearch.php" ;
        </script>
        <?php
}
}
