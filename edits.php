...
$result = mysqli_query($conn, "UPDATE street SET name='$name',sc='$sc' WHERE id='$id'");
...
$sqls=" SELECT * FROM locality where id='$lid'";
...
?>
 ...
 <form action="#" method="post">
            ...
            <input type="text" name="lid" value="<?php echo $l  ;?>" placeholder=" locality "  required="">
             <input type="text" name="sc" value="<?php echo$row["sc"]  ;?>" placeholder=" Street id" required="">
