...
$name = $_POST["name"];
$id=$_GET['id'];
  $sqlsa="Select * FROM street Where lid='$id'";
...
$sql="insert into street ( lid,name,sc) values ('$id','$name','$c')";
...
{ echo "&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp";
 echo "<tr>";
            ...
            echo "<td>".$row["name"]."</td>";
            echo "<td>".$row["sc"]."</td>";
            echo "<td><a class='up' href=\"edits.php?id=$row[id]\" >Edit</a> | <a class='up' href=\"deletes.php?id=$row[id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";
            ; 
