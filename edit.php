...
$result = mysqli_query($conn, "UPDATE postoffice SET pin='$pin' ,name='$name',ad='$address',state='$st' ,distr='$dst',type='$ty' WHERE id=$id");
...
<body>
	...
	$sql=" SELECT * FROM postoffice where id='$id'";
...
<center>
		...
		<form action="#" method="post">
            <input type="text" name="pin" value="<?php echo$row["pin"]  ;?>" placeholder="Enter pincode" required="">
			<input type="text" name="name" value=" <?php echo $row["name"]  ;?>" placeholder="Enter Name" required="">
			<textarea    name="address"  rows="2" cols="50" placeholder=" Address of postoffice" wrap="soft"><?php echo $row["ad"]  ;?></textarea><br><br>
			<input type="text" name="state"  value="<?php echo $row["state"]  ;?>" placeholder="Enter state" required="">
			<input type="text" name="District"  value="<?php echo $row["distr"]  ;?>" placeholder="Enter District" required="">
