...
$result = mysqli_query($conn, "UPDATE admin SET name='$name',usid='$usid',ppin='$ppin',phn='$phn',role='$role' WHERE id=$id");
...
?>
 ...
 <form action="#" method="post">
 	 <input type="text" name="usid" value="<?php echo$row["usid"]  ;?>" placeholder=" ID" required="">
            <input type="text" name="name" value="<?php echo$row["name"]  ;?>" placeholder=" Name" required="">
            <input type="text" name="phn" value="<?php echo$row["phn"]  ;?>" placeholder="phone" required="">
             <input type="text" name="ppin" value="<?php echo$row["ppin"]  ;?>" placeholder="post pin" required="">
